\section{Introducción a la PCR}

La técnica de la reacción en cadena de la polimerasa (PCR, por \textit{Polymerase Chain Reaction}) es una técnica de la biología molecular desarrollada en 1983 por Kary Mullis. Su objetivo es obtener un gran número de copias de un fragmento de ADN particular, partiendo de un mínimo; en teoría basta partir de una sola copia de ese fragmento original, o molde, para crea una gran dcantidad de copias del mismo.
